...
export default function FranchiseSignup() {
  ...
  const steps = [
    ...
    { num: 5, title: 'Location', icon: MapPin },
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="bg-white border-b border-gray-100 h-20 px-6 flex items-center justify-between sticky top-0 z-50">
        ...
        <div className="text-sm font-medium text-gray-500">
          Already have an account? <button onClick={() => navigate('/franchise/login')} className="text-[#E31837] hover:underline font-bold">Login here</button>
        </div>
      </header>
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto p-6 md:p-10 flex flex-col md:flex-row gap-12">
        ...
        {currentStep < 6 && (
          <div className="w-full md:w-64 flex-shrink-0">
            <h2 className="text-2xl font-bold text-gray-900 mb-8">Franchise Registration</h2>
        ...
        <div className="flex-1 bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-10">
          ...
          {currentStep === 5 && (
            <div className="animate-fade-in">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Configure Location</h3>
              <p className="text-gray-500 mb-8">Where will your franchise operate from?</p>
          ...
          {currentStep === 6 && (
            <div className="animate-fade-in text-center py-16">
              ...
              <p className="text-lg text-gray-600 max-w-lg mx-auto mb-10">
                Your franchise application has been received and is currently <span className="font-bold text-amber-600">Pending Verification</span> by our Head Office. We will notify you once approved.
              </p>
