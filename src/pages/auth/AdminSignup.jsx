...
export default function AdminSignup() {
  ...
  const steps = [
    ...
    { num: 3, title: 'Department', icon: Building2 },
    { num: 4, title: 'Identity', icon: FileText },
    { num: 5, title: 'Access', icon: MapPin },
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="bg-white border-b border-gray-100 h-20 px-6 flex items-center justify-between sticky top-0 z-50">
        ...
        <div className="text-sm font-medium text-gray-500">
          Already have an account? <button onClick={() => navigate('/admin/login')} className="text-[#E31837] hover:underline font-bold">Login here</button>
        </div>
      </header>
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto p-6 md:p-10 flex flex-col md:flex-row gap-12">
        ...
        {currentStep < 6 && (
          <div className="w-full md:w-64 flex-shrink-0">
            <h2 className="text-2xl font-bold text-gray-900 mb-8">Admin Registration</h2>
        ...
        <div className="flex-1 bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-10">
          ...
          {currentStep === 3 && (
            <div className="animate-fade-in">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Department Details</h3>
              <p className="text-gray-500 mb-8">Tell us about your department.</p>
              
              <div className="space-y-5">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Department Name</label>
                  <input type="text" className="w-full h-12 px-4 rounded-lg border border-gray-200 focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-gray-400" placeholder="e.g. Finance" />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                  ...
                  <div>
                    ...
                    <input type="text" className="w-full h-12 px-4 rounded-lg border border-gray-200 focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-gray-400" placeholder="EMP12345" />
                  </div>
                </div>
              </div>
            </div>
          ...
          {currentStep === 4 && (
            <div className="animate-fade-in">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Identity Details</h3>
              <p className="text-gray-500 mb-8">Required for internal verification.</p>
          ...
          {currentStep === 5 && (
            <div className="animate-fade-in">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Configure Access</h3>
              <p className="text-gray-500 mb-8">Which location will you be managing?</p>
              
              <div className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Hub/Branch Name</label>
                    <input type="text" className="w-full h-12 px-4 rounded-lg border border-gray-200" placeholder="e.g. Central Hub" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Manager Contact</label>
                    <input type="text" className="w-full h-12 px-4 rounded-lg border border-gray-200" placeholder="Name of reporting manager" />
                  </div>
                </div>
          ...
          {currentStep === 6 && (
            <div className="animate-fade-in text-center py-16">
              ...
              <p className="text-lg text-gray-600 max-w-lg mx-auto mb-10">
                Your admin registration has been received and is currently <span className="font-bold text-amber-600">Pending Verification</span> by HR. We will notify you once approved.
              </p>
