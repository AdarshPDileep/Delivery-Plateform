    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md" padding="p-8">
        <div className="text-center mb-6">
          <div className="w-12 h-12 bg-emerald-900 rounded-xl flex items-center justify-center mx-auto mb-4">
        ...
        <div className="flex gap-4 mb-6 border-b border-slate-200">
          <button 
            className={`pb-2 text-sm font-medium border-b-2 transition-colors flex-1 ${activeTab === 'login' ? 'border-emerald-800 text-emerald-900' : 'border-transparent text-slate-500'}`}
            onClick={() => setActiveTab('login')}
          >
            Sign In
          </button>
          <button 
            className={`pb-2 text-sm font-medium border-b-2 transition-colors flex-1 ${activeTab === 'register' ? 'border-emerald-800 text-emerald-900' : 'border-transparent text-slate-500'}`}
        ...
        {activeTab === 'login' ? (
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-emerald-800 hover:bg-emerald-900 focus:ring-emerald-700">Sign In</Button>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-emerald-800 hover:bg-emerald-900 focus:ring-emerald-700">Create Account</Button>
          </form>
        )}
      </Card>
    </div>
