      ...
      <main className="flex-1">
        ...
        <section className="py-24 px-6 max-w-6xl mx-auto w-full">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Choose {service.title}?</h2>
            ...
            {service.features.map((feature, idx) => (
              <div key={idx} className="bg-gray-50 rounded-2xl p-6 flex items-start gap-4 border border-gray-100 hover:border-gray-200 hover:shadow-md transition-all">
                ...
                <div>
                  ...
                  <p className="text-gray-500">We provide industry leading solutions tailored specifically for this feature to ensure maximum efficiency and reliability.</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="py-24 px-6 bg-gray-900 text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to scale your logistics?</h2>
